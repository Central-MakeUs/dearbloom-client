...
type TermsPageProps = {
  searchParams: Promise<{ forceOnboarding?: string; returnUrl?: string; role?: string }>;
};
...
export default async function TermsPage({ searchParams }: TermsPageProps) {
  ...
  const { forceOnboarding: forceOnboardingParam, returnUrl: returnUrlParam, role: roleParam } =
    await searchParams;
  ...
  return (
    <TermsAgreementForm
      forceOnboarding={shouldForceOnboarding(forceOnboardingParam)}
