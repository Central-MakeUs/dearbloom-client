    ...
    <div className="mx-auto max-w-md">
      ...
      {items.length === 0 ? (
        ...
        <ul className="flex flex-col gap-2 px-4 py-2">
          {items.map((it) => (
            <li key={it.inquiryId}>
              <a href={`/app/artist/requests/${it.inquiryId}?status=${it.status}`} className="block rounded-lg border border-neutral-200 bg-neutral-0 p-4 transition-colors hover:bg-neutral-50">
