...
const NICKNAME_MSG = '프로필 이름은 2~12자의 한글, 영문, 숫자, _ 와 단어 사이 공백만 가능합니다';
...
const CUSTOMER_NAME_MSG = `프로필 이름은 2~${CUSTOMER_NAME_MAX_LENGTH}글자 한글 또는 영문만 허용하며, 공백이나 숫자는 입력할 수 없습니다`;

/** 고객 이름: 2-5자, 한글 또는 영문(공백·숫자 불가). */
